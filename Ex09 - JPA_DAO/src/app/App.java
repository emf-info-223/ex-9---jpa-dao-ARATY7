...
public class App extends Application {
  ...
  private static final String TITLE = "JavaFX - Ex09 - Exercice avec couche DAO";
  ...
  /**
   * Méthode de démarrage d'une application JavaFX. C'est une méthode originale de la classe "Application" qui doit être
   * surchargée.
   *
   * @param stage l'estrade (là où se déroulent les scènes)
   */
  @Override
